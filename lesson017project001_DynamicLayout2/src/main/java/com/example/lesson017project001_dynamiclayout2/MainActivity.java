package com.example.lesson017project001_dynamiclayout2;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    /*
    rgGravity-это RadioGroup, с тремя RadioButton (rbLeft, rbCenter, rbRight).
    Этот компонент мы используем для выбора выравнивания создаваемого компонента
     */
    private RadioGroup rgGravity;
    /*
    etName – текстовое поле, здесь будем указывать текст,
    который будет отображаться на созданном компоненте
     */
